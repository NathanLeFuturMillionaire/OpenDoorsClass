        ...
        >
          <div className="mx-auto flex max-w-7xl items-center justify-center gap-3 px-4 py-2 text-center text-[0.8rem] sm:text-sm">
            <p className="text-white/85">
              <span aria-hidden="true">🌍</span> OpenDoorsClass est un centre de formation de langues 100% en ligne qui accueille des millions d&apos;étudiants venant du monde entier.
            </p>
            <a
              href="/a-propos"
